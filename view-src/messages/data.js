export const msgNames = {
  ...
  IPC_SET_TRAY_TOOLTIP_ERR:
    ...
    IPC_CHECK_FOR_UPDATES_ERR:
    'Ошибка при попытке проверить наличие обновлений',
  ...
  WGT_CR_ACTIVATED_RSV:
    'Активирован клановый резерв «‎‎%RESERV_NAME%» Активен до %ACTIV_TILL%',
};

export const wotApiMessages = {
...
export const osNoticeTypeNames = {
  reserve: 'Активация резерева',
  stop: 'Отключение виджета',
};

export const reserveStatusNames = {
  active: 'Активен',
