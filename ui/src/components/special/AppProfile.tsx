...
import { getAuth, getProfileInfo } from '@/store/selectors/profileSelectors';
  ...
  return (
    <>
      <TextField
        ...
        onChange={(e) => setFieldValue('name', formatNickName(e.target.value))}
        onBlur={submitForm}
      />
      {errors.name && (
