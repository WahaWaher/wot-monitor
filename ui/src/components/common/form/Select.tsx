...
const ClearIndicator: FC<any> = (props) => (
...
const Select: FC<ReactSelectProps> = ({ components, ...rest }) => (
  /* @ts-ignore */
  <Root
    ...
    {...rest}
    // menuIsOpen // for debuggin
  />
);

const Root = styled(ReactSelect)<ReactSelectProps>`
